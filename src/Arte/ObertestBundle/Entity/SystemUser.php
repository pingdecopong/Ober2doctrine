...
class SystemUser
{
     ...
     * Add watertanks
     *
     * @param \Arte\ObertestBundle\Entity\Watertank $watertanks
     * @return SystemUser
     */
    public function addWatertank(\Arte\ObertestBundle\Entity\Watertank $watertanks)
    {
     ...
     * @param \Arte\ObertestBundle\Entity\Watertank $watertanks
     */
    public function removeWatertank(\Arte\ObertestBundle\Entity\Watertank $watertanks)
    {
